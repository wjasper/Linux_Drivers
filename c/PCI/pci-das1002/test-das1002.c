 ...
 *  test-das1002.c
 *
 *  This program is used to test the PCI-DAS1002 Analog to Digital
...
char *DevName = "/dev/das1002/ad0_0";
...
void Usage( void )
{
  ...
  fprintf(stderr,"    [-dev /dev/das1002/ad0_#]  - Specify device file.\n");
...
void DoOpenDevices()
{
  ...
  strcpy(str, "/dev/das1002/dio0_0A");
  ...
  strcpy(str, "/dev/das1002/dio0_0B");
  ...
  strcpy(str, "/dev/das1002/dio0_0C");
