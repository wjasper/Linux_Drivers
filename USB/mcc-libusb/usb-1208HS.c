...
void usbAOutScanStart_USB1208HS(libusb_device_handle *udev, uint32_t count, uint32_t retrig_count, double frequency, uint8_t options)
{
  ...
  */
  ...
  if (frequency == 0.0) {
    ...
    AOutScan.pacer_period = rint((BASE_CLOCK / frequency) - 1);
  }
...
void usbTimerPeriodR_USB1208HS(libusb_device_handle *udev, float *period)
{
  ...
  */
  ...
  uint32_t value;
    ...
    perror("usbTimerPeriodR_USB1208HS error");
  }
...
void usbTimerPeriodW_USB1208HS(libusb_device_handle *udev, float period)
{
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_PERIOD, wValue, wIndex, NULL, 0x0, HS_DELAY) < 0) {
    perror("usbTimerPeriodW_USB_1208HS error.");    
  }
}
...
void usbTimerPulseWidthR_USB1208HS(libusb_device_handle *udev, float *pulseWidth)
{
  ...
  */
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_PULSE_WIDTH, 0x0, 0x0, (unsigned char *) &pulse_width, sizeof(pulse_width), HS_DELAY) < 0) {
    perror("usbTimerPulseWidthR_USB1208HSerror.");
  }
...
void usbTimerPulseWidthW_USB1208HS(libusb_device_handle *udev, float pulseWidth)
{
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_PULSE_WIDTH, wValue, wIndex, NULL, 0x0, HS_DELAY) < 0) {
    perror("usbTimerPulseWidthW_USB1208HS: error.");
  }
}
...
void usbTimerCountR_USB1208HS(libusb_device_handle *udev, uint32_t *count)
{
  ...
  */
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_COUNT, 0x0, 0x0, (unsigned char *) count, sizeof(count), HS_DELAY) < 0) {
    perror("usbTimerCountR_USB1208HS error.");
  }
}
...
void usbTimerCountW_USB1208HS(libusb_device_handle *udev, uint32_t count)
{
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_COUNT, wValue, wIndex, NULL, 0x0, HS_DELAY) < 0) {
    perror("usbTimerCountW_USB1208HS error.");
  }
}
...
void usbTimerDelayR_USB1208HS(libusb_device_handle *udev, float *delay)
{
  ...
  */
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_START_DELAY, 0x0, 0x0, (unsigned char *) &value, sizeof(value), HS_DELAY) < 0) {
    perror("usbTimerDelayR_USB1208HS: error.");
  }
...
void usbTimerDelayW_USB1208HS(libusb_device_handle *udev, float delay)
{
  ...
  if (libusb_control_transfer(udev, requesttype, TIMER_START_DELAY, wValue, wIndex, NULL, 0x0, HS_DELAY) < 0) {
    perror("usbTimerDelayW_USB1208HS: error.");
  }
}
