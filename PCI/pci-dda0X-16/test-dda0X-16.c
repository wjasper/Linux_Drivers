 ...
 *  test-dda0X_16.c
 *
 *  This program is used to test the PCI-DDA0X-16 
...
{
  fprintf(stderr, "\n");
  fprintf(stderr, "Usage: test-dda0X_16 \'options\'\n");
  fprintf(stderr, "Options:\n");
  fprintf(stderr, "    [-dev /dev/dda0x_16/dio0_{A,B,C}]  - Specify device file.\n");
