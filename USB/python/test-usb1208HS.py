...
# print out the calibration tables
  ...
  while True:
    ...
    if ch == 'b':
      ...
      usb1208HS.AInConfigW(0, channel, gain, mode, lastElement=True)
      while True:
        try:
          value = usb1208HS.AIn(channel, gain)
        except ValueError as e:
          print(e)
          break
        print("AIn: %#x  volt = %f" % (value, usb1208HS.volts(gain, value)))
        if toContinue() != True:
          break
    elif ch == 'M':
