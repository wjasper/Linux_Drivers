 ...
 *  test-dio96H.c
 *
 *  This program is used to test the PCI-DIO96H Digital I/O
 *  Linux loadable module(pci-dio96H).
 *
 ***************************************************************************/
...
char *DevName = "/dev/dio96H/dio0_0A";
char DevNameIO[20];
int  Count    = 1;
int  NoStop   = 0;
int  Mode     = 0;
...
{
  fprintf(stderr, "\n");
  fprintf(stderr, "Usage: test-dio96H \'options\'\n");
  fprintf(stderr, "Options:\n");
  fprintf(stderr, "    [-dev /dev/dio96H_0{A,B,C}]  - Specify device file.\n");
