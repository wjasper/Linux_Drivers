/*
 * Copyright (C) 2003  Warren Jasper
 * All rights reserved.
 */
 ...
 *  test-das1001.c
 *
 *  This program is used to test the PCI-DAS1001 Analog to Digital
...
char *DevName = "/dev/das1001/ad0_0";
int  ADC_Gain     = UP_10_00V;
int  DAC_Gain0    = UP_10_00V;
int  DAC_Gain1    = UP_10_00V;
...
void Usage( void )
{
  ...
  fprintf(stderr,"    [-dev /dev/das1001/ad0_#]  - Specify device file.\n");
...
void DoOpenDevices()
{
  ...
  strcpy(str, "/dev/das1001/dio0_0A");
  ...
  strcpy(str, "/dev/das1001/dio0_0B");
  ...
  strcpy(str, "/dev/das1001/dio0_0C");
  ...
  ioctl(fdDAC0, DAC_SET_GAINS, DAC_Gain0);
  ioctl(fdDAC1, DAC_SET_GAINS, DAC_Gain1);
}
...
void ChangeADCGains()
{
    ...
    printf("  2.   Bipolar +/-  1.00V.\n");
    printf("  3.   Bipolar +/-  0.10V.\n");
    printf("  4.   Bipolar +/-  0.01V.\n");
    printf("  5.   Unipolar     0-10.00V.\n");
    printf("  6.   Unipolar     0-1.00V.\n");
    printf("  7.   Unipolar     0-0.10V.\n");
    printf("  8.   Unipolar     0-0.01V\n");
    printf("\nOption: ");
    scanf("%d", &choice);
    switch(choice){
    case 1:
      ...
      break;
    case 2:
      ioctl(fdADC, ADC_SET_GAINS, BP_1_00V);
      ADC_Gain = BP_1_00V;
      break;
    case 3:
      ioctl(fdADC, ADC_SET_GAINS, BP_0_10V);
      ADC_Gain = BP_0_10V;
      break;
    case 4:
      ioctl(fdADC, ADC_SET_GAINS, BP_0_01V);
      ADC_Gain = BP_0_01V;
      break;
    case 5:
      ioctl(fdADC, ADC_SET_GAINS, UP_10_00V);
      ...
      break;
    case 6:
      ioctl(fdADC, ADC_SET_GAINS, UP_1_00V);
      ADC_Gain = UP_1_00V;
      break;
    case 7:
      ioctl(fdADC, ADC_SET_GAINS, UP_0_10V);
      ADC_Gain = UP_0_10V;
      break;
    case 8:
      ioctl(fdADC, ADC_SET_GAINS, UP_0_01V);
      ADC_Gain = UP_0_01V;
      break;
    default:
...
void ChangeDACGains()
{
	...
	break;
      case 3:
	ioctl(fdDAC1, DAC_SET_GAINS, UP_10_00V);
	DAC_Gain1 = UP_10_00V;
	break;
      case 4:
	ioctl(fdDAC1, DAC_SET_GAINS, UP_5_00V);
	DAC_Gain1 = UP_5_00V;
	break;
      default:
	printf("Illegal option.\n");
